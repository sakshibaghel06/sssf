      ...
      <section className="container-seva py-16 md:py-20">
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Link href="/programs" className="rounded-full bg-maroon px-6 py-3 text-sm font-semibold text-ivory dark:bg-marigold dark:text-charcoal">
              Explore Our Programs
            </Link>
            <Link href="/impact" className="rounded-full border border-maroon px-6 py-3 text-sm font-semibold text-maroon dark:border-marigold dark:text-marigold">
              View Our Impact
            </Link>
          </div>
        </div>
            ...
            {beneficiaryStoriesContent.length === 0 ? (
              ...
              <div className="grid gap-4">
                {beneficiaryStoriesContent.map((story) => (
                  <article key={story.id} className="rounded-2xl border border-maroon/10 dark:border-marigold/15 p-6">
                    <div className="flex flex-wrap items-center justify-between gap-4">
                      <div>
                        <span className="font-display text-lg text-maroon dark:text-ivory">
                    ...
                    <div className="mt-5 grid gap-4 md:grid-cols-2">
                      <div>
                        ...
                        <p className="mt-4 text-sm leading-relaxed text-sandalwood dark:text-ivory-soft/70">
                          <strong className="text-maroon dark:text-ivory">Challenge:</strong> {story.challenge}
                        </p>
                        <p className="mt-3 text-sm leading-relaxed text-sandalwood dark:text-ivory-soft/70">
                          <strong className="text-maroon dark:text-ivory">Assistance:</strong> {story.assistance}
                        </p>
                        {story.outcome ? (
                          <p className="mt-3 text-sm leading-relaxed text-sandalwood dark:text-ivory-soft/70">
                            <strong className="text-maroon dark:text-ivory">Outcome:</strong> {story.outcome}
                          </p>
                        ) : null}
                      </div>
