...
- Light/dark visual theme support.
...
- `components/ThemeProvider.tsx` — Theme context and provider for light/dark switching.
...
- The website uses light/dark theme support via `next-themes` and a custom `ThemeProvider`.
